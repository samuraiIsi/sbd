...
export class InMemoryDataService implements InMemoryDbService {
    createDb() {
        ...
        let homeBoxesEN = [
            {
                ...
                headerText: '',
                image: 'src/assets/images/mapa-mundi.jpg',
                imageClass: '', 
            ...
            },
            {
                ...
                articleClass: 'boxes bg-border-img',
                headerText: '',
                image: 'src/assets/images/sport-orig_280x130.jpg',
                imageClass: '', 
            ...
            },
            {
                ...
                articleClass: 'boxes',
                headerText: '',
                image: 'src/assets/images/entrepreneur_280x130.jpg',
                imageClass: '', 
        ...
        let detailsEN = [{
                ...
                image: 'src/assets/images/michael_263x452.jpg',
            ...
            },
            {
                ...
                subTitle: 'Owner- Director',
                image: 'src/assets/images/carlos_263x452.jpg',
        ...
        let agenciesEN = [{
                ...
                image: 'src/assets/images/aads_400x300.jpg',
                btnLinkA: 'aads',
            ...
            },
            {
                ...
                image: 'src/assets/images/smile_400x300.jpg',
                btnLinkA: 'sports',
        ...
        let associatesEN = [
            {
                ...
                subTitle: 'LAWYER',
                image: 'src/assets/images/carmona_263x452.jpg',
            ...
            },
            {
                ...
                image: 'src/assets/images/laurel-balance-peru-flag.jpg',
            ...
            },
            {
                ...
                image: 'src/assets/images/hassans_400x300.png',
                imageClass: 'img-text-pages',
                btnLinkA: 'hassans',
            ...
            },
            {
                ...
                subTitle: 'ASSOCIATES',
                image: 'src/assets/images/yakolev_400x300.png',
                imageClass: 'img-text-pages',
            ...
            },
            {
                ...
                image: 'src/assets/images/angola_400x300.jpg',
                imageClass: 'img-text-pages',
                btnLinkA: 'angola',
                text: "It needs text"
            }
        ...
        let boxespanelEN = [{
                ...
                headerText: 'spain',
                image: 'src/assets/images/gavel_400x300.jpg',
        ...
        let carouselhome = [
            {
                image: 'src/assets/images/gibraltar_1904x598.jpg',
                header: 'Gibraltar',
                liClass: 'slide1',
            ...
            {
                image: 'src/assets/images/machu-pichu_1904x598.jpg',                
                header: 'Peru',
                liClass: 'slide2',
